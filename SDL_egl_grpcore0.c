/* 
 * Patched SDL_egl.c from Git:0e7b72b155c536cce990b40eeb6366a1017f8bd5
 *
 *  - Try to link against OpenGL libraries statically
 *  - Remove RPi support (static linking simply won't work for us)
 */
...
/* grpcore0: Include EGL Header */
#include <EGL/egl.h>
#include <EGL/eglext.h>

/* grpcore0: ... and our own LOAD_FUNC which does short-circuit */
...
SDL_EGL_UnloadLibrary(_THIS)
{
    if (_this->egl_data) {
        ...
        /* grpcore0: Don't try to unload EGL */
